 ...
 * bipartite. If so, the color operation determines a bipartition;
 * if not, the oddCycle operation determines a cycle with an odd
 * number of edges.
 * 
 ...
 * the oddCycle operation takes time proportional to the length of the 
 * cycle.
 *
 */
public class Bipartite {
	...
	private int[] edgeTo;		 	// edgeTo[v] = last edge on path to v												n
	...
	/**
	 * Returns the side of the bipartitie that vertex v is on.
	 * @param v the vertex
	...
	public boolean color(int v)
	{
		if(!isBipartite)
		{
			throw new UnsupportedOperationException("Graph is not bipartitie");
		}
		return color[v];
	}
